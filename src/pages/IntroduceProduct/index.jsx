...
function IntroduceProductPage() {
  ...
  const product = data.find(
    (product) => product.id === parseFloat(params.productId)
  );
      ...
      <div className="Laptop-L:px-5">
        ...
        <div className="hidden px-5 py-4 my-5 overflow-hidden rounded-lg Laptop-L:block">
          <a href="https://digikala-service.com/">
            <img
              src={
                'https://dkstatics-public.digikala.com/digikala-admin-landing/6318364ab23fcfc2cfaaa1924ec0ec95172e1022_1678538975.jpg'
              }
              alt="sub image"
        ...
        <div className="px-5 py-4 my-5 overflow-hidden rounded-lg Laptop-L:hidden Laptop-L:px-0">
          <a href="https://digikala-service.com/">
            <img
              src={
                'https://dkstatics-public.digikala.com/digikala-admin-landing/025ec5fcc64cd2d1d403ee1bb95061fa26eaa7e3_1678538985.jpg'
              }
              alt="sub image"
        ...
        <div
          id="intro"
          className="hidden px-5 py-4 my-5 overflow-hidden rounded-lg Laptop-L:block"
        >
          <a href="https://digikala-service.com/">
            <img
              src={
                'https://dkstatics-public.digikala.com/digikala-admin-landing/b00e0cf8908bcb4ea3a16c685b4486a83333a38d_1687621025.jpg'
              }
              alt="sub image"
              className="rounded-lg"
            />
