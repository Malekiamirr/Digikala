      ...
      {whichPage.cart && (
        <div className="relative">
          <div className="pb-3">
            {/* Digi-Plus */}
            {isLoggedIn && (
              <div className="flex flex-col items-center Laptop-L:flex-row gap-4 mt-4 relative">
                <div className="px-2 py-1 border-y Laptop-L:border-none bg-white Laptop-L:px-0 grow">
                        ...
                        {activeUser?.cart.map((p) => (
                          ...
                          >
                            <div className="flex flex-col Tablet:grid grid-cols-116px-1fr gap-6">
                              ...
                              {/* Add & Remove button */}
                              <div className="Laptop-L:block hidden"></div>
                        ...
                        <div className="py-3 px-4 border border-[#f1f2f4] rounded-lg">
                          <div className="py-3 break-words">
                            ...
                            <p className="pr-7 text-[11px] Tablet:text-xs text-[#767790] Laptop-L:leading-6 leading-6">
                              برای مشاهده محصولاتی که پیش‌تر به سبد خرید خود
                              اضافه کرده‌اید وارد شوید.
                            </p>
                          </div>
                        </div>
                      </Link>
