...
function DynamicProductListPage() {
  ...
  if (filteredProducts.length === 0) {
    filteredProducts = products.filter(
      (product) => product.categorySlug === params.searchId
    );
  }
  ...
  if (isApple) {
    if (isJustDiscount) {
      filteredProducts = products.filter(
        (product) => product.brand && product.brand === 'اپل'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = products.filter(
  ...
  if (isSamsung) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) => product.brand && product.brand === 'سامسونگ'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
  ...
  if (isNokia) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) => product.brand && product.brand === 'نوکیا'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
  ...
  if (isOneSIMcard) {
    if (isJustDiscount) {
      filteredProducts = products.filter(
        (product) =>
          product.productsValues[0] &&
          product.productsValues[0].value === 'یک عدد'
      );
      filteredProducts = products.filter((product) => product.offer);
    } else {
      filteredProducts = products.filter(
        (product) =>
          product.productsValues[0] &&
  ...
  if (isTwoSIMcard) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) =>
          product.productsValues[0] &&
          product.productsValues[0].value === 'دو عدد'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
  ...
  if (isThreeSIMcard) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) =>
          product.productsValues[0] &&
          product.productsValues[0].value === 'سه عدد'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
  ...
  if (is2G) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) =>
          product.productsValues[1] && product.productsValues[1].value === '2G'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
  ...
  if (is3G) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) =>
          product.productsValues[1] && product.productsValues[1].value === '3G'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
  ...
  if (is4G) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) =>
          product.productsValues[1] && product.productsValues[1].value === '4G'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
  ...
  if (is5G) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) =>
          product.productsValues[1] && product.productsValues[1].value === '5G'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
        (product) => product.productsValues[1].value === '5G'
      );
    }
  }
  ...
  if (isRAM2) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) => product.productsValues[2]?.value === 'دو گیگابایت'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
  ...
  if (isRAM4) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) => product.productsValues[2]?.value === 'چهار گیگابایت'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
  ...
  if (isRAM16) {
    if (isJustDiscount) {
      filteredProducts = filteredProducts.filter(
        (product) => product.productsValues[2]?.value === 'شانزده گیگابایت'
      );
      filteredProducts = filteredProducts.filter((product) => product.offer);
    } else {
      filteredProducts = filteredProducts.filter(
                ...
                <div className="flex border-b">
                  ...
                  <div className="items-center justify-between hidden grow Laptop-L:flex">
                    ...
                    <div className="text-xs text-[#767790]">
                      {convertToPersian(filteredProducts.length)}
                    </div>
                  </div>
                </div>
              )}
              <ShowPhoneCards phones={filteredProducts} />
            </div>
          </section>
        </div>
      </div>
