...
function RegisterComment({ onClose, product }) {
  ...
  useEffect(() => {
    if (commentInput) {
      setIsValidToSubmit({
        commentInput: false,
        textareaValue: isValidToSubmit.textareaValue,
      });
    }

    if (textareaValue) {
      setIsValidToSubmit({
        commentInput: isValidToSubmit.commentInput,
        textareaValue: false,
      });
    }
  ...
  const addPositivePoints = () => {
    ...
    console.log(positivePoints.length);
    setPositivePointComment('');
  };
  ...
  const addNegativePoints = () => {
    ...
    console.log(negativePoints.length);
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-50 flex items-center justify-center w-full h-screen bg-black bg-opacity-20`}
    >
        ...
        <div className="px-5">
          <div className="border-b border-b-[#e0e0e6] flex items-center justify-between ">
            <div className="flex flex-col gap-2 py-3">
              ...
              <p className="text-xs text-[#767790]">{product.name}</p>
            </div>
          ...
          <div>
            <div className="flex h-[100%] px-5">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="flex flex-col px-3 pt-4 pb-6">
                    ...
                    <div className="flex flex-col items-center justify-center border-b">
                      <p>
                        <span className="ml-1 text-[#b2001a]">*</span>امتیاز
                        دهید!:
                      </p>
                      ...
                      <div className="px-2 border border-[#e0e0e6] h-[48px] rounded-lg flex items-center justify-center">
                        <div className="w-full">
                          <input
                            ...
                            className="px-2 outline-none text-[15px] text-[#3f4064] caret-[#ef4056]"
                          />
                        </div>
                      </div>
                      {/* error message */}
                      {isValidToSubmit.commentInput && (
                        <p className="text-xs text-[#b2001a] font-Yekan-bold py-3">
                    ...
                    <div className="flex flex-col pt-[18px] pb-6 mt-3">
                      ...
                      <div className="px-2 border border-[#e0e0e6] h-[48px] rounded-lg flex items-center justify-center">
                        <div className="flex items-center justify-between w-full">
                          <input
                            type="text"
                            value={PositivePointComment}
                            onChange={handlePositivePointComment}
                            className="px-2 outline-none text-[15px] text-[#3f4064] caret-[#ef4056]"
                          />
                          <BiPlus
                            onClick={addPositivePoints}
                            className={`${
                              !PositivePointComment && 'pointer-events-none'
                            } w-6 h-6 text-[#9e9fb1] hover:cursor-pointer`}
                          />
                        </div>
                      </div>
                          ...
                          >
                            ...
                            <div className="flex items-center">
                              <TbTrash
                                ...
                                className="text-[#9e9fb1] w-5 h-5 hover:cursor-pointer"
                              />
                            </div>
                          </div>
                        ))}
                    ...
                    <div className="flex flex-col pt-[18px] pb-6 mt-3">
                      ...
                      <div className="px-2 border border-[#e0e0e6] h-[48px] rounded-lg flex items-center justify-center">
                        <div className="flex items-center justify-between w-full">
                          <input
                            type="text"
                            value={NegativePointComment}
                            onChange={handleNegativePointsComment}
                            className="px-2 outline-none text-[15px] text-[#3f4064] caret-[#ef4056]"
                          />
                          <BiPlus
                            onClick={addNegativePoints}
                            className={`${
                              !NegativePointComment && 'pointer-events-none'
                            } w-6 h-6 text-[#9e9fb1] hover:cursor-pointer`}
                          />
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col mt-2 gap-3">
                        {negativePoints.map((point, i) => (
                          ...
                          >
                            <div className="flex items-center">
                              <BiMinus className="w-5 h-5 text-[#b2001a]" />
                              <p className="mr-2 text-xs">{point}</p>
                            </div>
                            <div className="flex items-center">
                              <TbTrash
                                onClick={() => {
                                  setNegativePoints(
                                    negativePoints.filter((p) => p !== point)
                                  );
                                }}
                                className="text-[#9e9fb1] w-5 h-5 hover:cursor-pointer"
                              />
                    ...
                    <div className="flex flex-col mt-2">
                      <p className="mb-2 text-sm">
                        متن نظر <span className="text-[#b2001a]">*</span>
                      </p>
                      <div className="px-2 border border-[#e0e0e6] rounded-lg flex items-center">
                        <div className="grow">
                          <textarea
                            ...
                            className="px-1 text-[#3f4064] caret-[#ef4056] text-[15px] resize-none outline-none py-2"
                    ...
                    <div className="flex items-center pt-4 pb-5 my-1">
                      <label className="flex items-center">
                        <input
                          className="accent-[#0fabc6] w-4 h-4"
                          type="checkbox"
                          checked={isChecked}
                          onChange={handleCheckboxChange}
                        />
                      </label>
                      <p className="mr-5 text-xs font-Yekan-bold">
              ...
              <div className="hidden px-4 py-5 mr-5 border rounded-lg Laptop-L:block">
                {/* Heaeder */}
                <div className="py-3">
                  <p className="font-Yekan-bold text-[#080a38] leading-5 mb-4">
                ...
                <div className="text-xs leading-7">
                  <p className="text-xs text-[#2980b9] font-Yekan-bold mb-2">
                  ...
                  <ul>
                    <li>
                      با مطالعه‌ی{' '}
                      <a
                        href="https://www.digikala.com/mag/how-to-create-compelling-lifestyle-product-photographs/"
                        className="text-[#2980b9] underline font-Yekan-bold"
                      >
                        این لینک
                      </a>{' '}
                  ...
                  <p>
                    هرگونه نقد و نظر در خصوص سایت دیجی‌کالا، مشکلات دریافت خدمات
                    و درخواست کالا و نیز گزارش تخلف فروش (نظیر گزارش کالای
                    غیراصل یا مغایر) را با ایمیل{' '}
                    <a href="" className="text-[#0000EE] font-Yekan-bold">
                      info@digikala.com
                    </a>{' '}
                    یا با شماره‌ی{' '}
            ...
            <div className="flex items-center gap-10 justify-between p-5 bg-white shadow-[0px_-5px_8px_1px_#00000024]">
              <button
                ...
                className="px-4 py-3 bg-[#ef4056] text-white text-sm font-Yekan-bold rounded-lg grow"
              >
                ثبت دیدگاه
              </button>
              ...
              <p className="text-[11px] font-Yekan-medium">
                ثبت دیدگاه به معنی{' '}
                <span className="text-[#19bfd3]">موافقت باقوانین انتشار</span>{' '}
                دیجی‌کالااست.
              </p>
            </div>
          </div>
