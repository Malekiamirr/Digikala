// Images
import navbar from "../../assets/imgs/navbar2.gif";
...
import { HiOutlineUser, HiOutlineLogin, HiOutlineMenu,HiOutlineLocationMarker } from "react-icons/hi";
                  ...
                  {isUserLogin ? (
                    ...
                    <>                   
                     <div className='hidden Laptop-L:flex items-center gap-2 text-[##080a38] px-4 py-2 border rounded-lg border-[#e0e0e6]'>
                      ...
                      <p className='text-xs font-Yekan-bold'>ورود | ثبت‌نام</p>
                    </div>
