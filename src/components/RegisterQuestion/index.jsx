...
function RegisterQuestion({ onClose }) {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-50 flex justify-center items-center w-full h-screen bg-black bg-opacity-20`}
    >
      <div className="w-[420px] h-[60px] bg-white rounded-lg -translate-y-[200%]">
        ...
        <div className="px-5">
          <div className="flex items-center justify-between border-b border-b-[#e0e0e6]">
            <p className="py-3 text-[#080a38] font-Yekan-bold">
            ...
            <div className="border border-[#e0e0e6] rounded-lg flex items-center justify-center">
              <div className="w-full">
                <textarea
                  ...
                  onChange={handleText}
                  value={text}
                  className="w-full px-3 py-2 outline-none resize-none text-[15px] text-[#3f4064]"
                ></textarea>
              </div>
            </div>
        ...
        <div className="bg-white shadow-[0px_1px_4px_3px_#00000024] py-4 px-5">
          <div className="flex flex-col items-center">
            <button
              ...
              className={`${
                text.length > 7 ? 'bg-[#ef4056]' : 'bg-[#e0e0e6]'
              } px-4 py-3 w-full rounded-lg text-sm font-Yekan-bold text-white`}
            >
              ثبت پرسش
            </button>
